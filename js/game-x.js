...
import { GAME_CONFIG, CanvasDimensions } from './config.js';
...
class RejasEspacialesGame {
    ...
    async initialize() {
        try {
            console.log('🎯 PASO 1: Calculando resoluciones y configurando canvas...');
            // Importar la función de cálculo de dimensiones
            const { calculateAndSetupCanvas } = await import('./setupCanvas.js');
            
            // Calcular resoluciones y configurar canvas ANTES de todo
            const dimensions = await calculateAndSetupCanvas();
            if (!dimensions) {
                throw new Error('Error al calcular dimensiones del canvas');
            }
            
            console.log('🎯 PASO 2: Obteniendo contexto del canvas...');
            ...
            console.log('🎯 PASO 3: Configurando elementos del DOM...');
            this.setupDOMElements();
            
            console.log('🎯 PASO 4: Configurando controles...');
            this.setupControls();
            
            console.log('🎯 PASO 5: Inicializando sistema de audio...');
            ...
            console.log('🎯 PASO 6: Inicializando sistema de modales P5...');
            initModales();
            
            // Inicializar sistemas para mostrar en pantalla de instrucciones
            console.log('🎯 PASO 7: Inicializando sistemas para pantalla de instrucciones...');
